export const SITE_TITLE = "Hackerspace Castellón";
...
export const QUOTE = "Para los amantes de la informática, la electrónica, los videojuegos y el conocimiento libre.";
export const NAV_LINKS: Array<{ title: string; href?: string }> = [
  ...
  {
    title: "Wiki",
    href: "//hackcs.notion.site/8effcb7d456a4f66b2e7758941d0fdef?v=12646f61f7f780ec99c9000c1bb06901",
  },
];
